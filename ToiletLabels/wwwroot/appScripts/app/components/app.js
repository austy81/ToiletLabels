...
var browse_1 = require('../../browse/components/browse');
var add_label_1 = require('../../add_label/components/add_label');
...
var AppCmp = (function () {
    ...
    AppCmp = __decorate([
        core_1.Component({
            selector: 'my-app',
            //viewProviders: [LabelsService],
            templateUrl: './appScripts/app/components/app.html',
